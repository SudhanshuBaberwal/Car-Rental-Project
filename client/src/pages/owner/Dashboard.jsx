  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-l">
      <Title
        ...
        subTitle="Monitor overall platform performance including total cars, revenue and recent activities"
      />
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-3xl">
        {dashboardCards.map((card, index) => (
          <div
            key={index}
            className="flex gap-2 items-center justify-between p-4 rounded-xl border border-border-gray-200 bg-white shadow-sm hover:shadow-md transition"
          >
            <div>
      ...
      <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
        <div className="p-4 md:p-5 border border-borderColor rounded-md max-w-lg w-full">
          {/* recent bookings div */}
