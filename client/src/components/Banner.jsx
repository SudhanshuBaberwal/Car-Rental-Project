  ...
  [#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden"
    >
      <div className="text-white">
        ...
        <p className="mt-2">
          monetize your vehicle effoortlessly by listing it on CarRental.
        </p>
        <p className="max-w-130">
          We take care of insurance, driver verification and secure payments-So
          you can earn passive income, stress-free
        </p>
        <motion.button whileHover={{scale : 1.05}} whileTap={{scale : 0.95}} className="px-6 py-2 bg-white hover:bg-slate-100 transition-all text-black rounded-lg text-sm mt-4 cursor-pointer">
          List Your Car
        </motion.button>
      </div>
