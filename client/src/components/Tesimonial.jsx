...
const Tesimonial = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            testimonial: "I highyl recommend CarRental! Their fleet is amazing and I always feel like I'm getting the best deal with excellent service"
        },
        {
            name: "Priyanshu Baberwal",
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            traverlers choose StayVenture for their luxury accommodation around the world"/>
