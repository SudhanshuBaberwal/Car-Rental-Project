...
const ForgotPassword = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Simulate the API call being successful
    setIsSubmitted(true);
  };
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 sm:text-sm border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 py-3 border outline-none transition-colors"
